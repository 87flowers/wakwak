...
pub const TRIPLET_CORR_SIZE: usize = 16384;
...
pub struct History {
    ...
    kpr_corr: CorrHistory<TRIPLET_CORR_SIZE>,
}
...
impl History {
    ...
    pub fn update_corr(&mut self, board: &Board, depth: i32, score: Score, static_eval: Score) {
        ...
        self.kpr_corr.update(stm, board.kpr_hash(), depth, diff);
    }
    ...
    pub fn corr(&self, board: &Board) -> i32 {
        ...
        corr += Params::kpr_corr() * self.kpr_corr.entry(stm, board.kpr_hash());
        corr / MAX_CORR
    }
}
